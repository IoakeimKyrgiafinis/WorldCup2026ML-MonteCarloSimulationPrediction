...
$$\lambda_a = \max\!\left(0.5,\ 1.5 + \frac{\text{value diff}}{10^9}\right)$$

$$\lambda_b = \max\!\left(0.5,\ 1.5 - \frac{\text{value diff}}{10^9}\right)$$
...
---
## Final Tournament Simulation Probabilities (2026 World Cup)

Below are the aggregated title-winning probabilities derived from 10,000 Monte Carlo tournament iterations.
